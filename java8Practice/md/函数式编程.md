...
~~~~
   ...
   直接调sorted()方法运行是会报错的，因为没有实现Comparable接口。会报如下错误：

```java
Exception in thread "main" java.lang.ClassCastException: com.ransibi.streampractice.pojo.Author cannot be cast to java.lang.Comparable
	...
	at com.ransibi.streampractice.mediumoperator.Demo.test03(Demo.java:174)
	at com.ransibi.streampractice.mediumoperator.Demo.main(Demo.java:32)
```

  解决方法：需要在实体中实现Comparable方法：
